function ftf(){
	var b=this,m="",k=3,e= {text_download:"Download",text_upgrade_now:"Upgrade",text_you:"YOU",button_continue:"Continue Anyway",button_close:"Close",text_you_are_using:"You are using",message_failed:"Please use one of these browsers as we prepare the interactive map for Internet Explorer.",message_acceptable:"Not bad. Try using our other recommendations.",message_recommended:"Good choice. Stick with it.",message_error:"Sorry, something went wrong. We're fixing it.",status_loading:"Loading...",status_approved:"Browser Approved.",status_acceptable:"Browser Acceptable.",status_failed:"Browser Failed.",link_check:"Check"},g=
		{
		firefox:
			{
			url:"http://www.mozilla.com/en-US/firefox/firefox.html",version:"3.6"
		}
		,chrome:
			{
			url:"http://www.google.com/chrome/index.html?hl=en-GB&brand=CHMA&utm_campaign=en_gb&utm_source=en_gb-ha-apac-in-bk&utm_medium=ha",version:"7.0"
		}
		,opera:
			{
			url:"http://www.opera.com/download/",version:"10.6"
		}
		,safari:
			{
			url:"http://www.apple.com/safari/download/",version:"5.0"
		}
	};
	b.rate=
		{
		firefox:1,chrome:1,opera:2,safari:1,ie6:3,ie7:3,ie8:2
	};
	b.icons=
		{
		firefox:"icons/32/firefox.gif",chrome:"icons/32/chrome.gif",opera:"icons/32/opera.gif",safari:"icons/32/safari.gif",ie6:"icons/32/ie6.gif",ie7:"icons/32/ie7.gif",ie8:"icons/32/ie8.gif"
	};
	b.instance_name="ftf";
	b.output_to="ftf_link";
	b.css_external="http://freethefoxes.googlecode.com/svn/trunk/css/latest.v3.css";
	b.lang_external="";
	b.onload=true;
	b.get_obj=function()
		{
	...
	b.get_browser_version=function(a,d)
		...
		if(/firefox[\/\s](\d+\.\d+)/.test(navigator.userAgent.toLowerCase()))c=RegExp.$1;
			...
			var f=c.indexOf("Safari"),j=c.substr(0,f).lastIndexOf("/")+1;
			c=c.substr(j,f-j);
	...
	b.build=function()
		...
		i++)
			...
			switch(k)
				{
				case 1:d.push(Browsers[i]);
				break;
				case 2:c.push(Browsers[i]);
				break;
				case 3:f.push(Browsers[i]);
				break;
				default:f.push(Browsers[i])
			}
		}
		...
		switch(k)
			{
			case 1:a.push('<div id="ftf_header" class="ftf_recommended">');
			a.push(e.text_you_are_using+' <span class="ftf_browser_name">'+m+"</span><br />");
			a.push(e.message_recommended);
			a.push("</div>");
			break;
			case 2:a.push('<div id="ftf_header" class="ftf_acceptable">');
			a.push(e.text_you_are_using+' <span class="ftf_browser_name">'+m+"</span><br />");
			a.push(e.message_acceptable);
			a.push("</div>");
			break;
			case 3:a.push('<div id="ftf_header" class="ftf_failed">');
			a.push(e.text_you_are_using+' <span class="ftf_browser_name">'+m+"</span><br />");
			a.push(e.message_failed);
			a.push("</div>");
			break;
			default:a.push('<div id="ftf_header" class="ftf_failed">');
		...
		switch(k)
			{
			case 1:c.push(e.status_approved);
			break;
			case 2:c.push(e.status_acceptable);
			break;
			case 3:c.push(e.status_failed);
			break;
			default:c.push("FTF Error")
		}
	...
	b.browser=function(a,d,c,f,j,n)
		{
		var h=[],l="ftf_browser_link";
		switch(d)
			{
			case 1:l+=" recommended";
			break;
			case 2:l+=" appectable";
			break;
			case 3:l+=" failed"
